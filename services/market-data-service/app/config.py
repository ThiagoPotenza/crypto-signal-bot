...
# PostgreSQL - USANDO IP DIRETO
POSTGRES_HOST = os.getenv("POSTGRES_HOST", "172.19.0.3")  # IP do postgres-market-data
POSTGRES_PORT = int(os.getenv("POSTGRES_PORT", "5432"))
POSTGRES_DB = os.getenv("POSTGRES_DB", "market_data")
POSTGRES_USER = os.getenv("POSTGRES_USER", "postgres")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD", "postgres123")

# Redis - USANDO IP DIRETO
REDIS_HOST = os.getenv("REDIS_HOST", "172.19.0.2")  # IP do redis-market-data
